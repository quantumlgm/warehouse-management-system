...
class Warehouses(Base):
    ...
    incoming_shipments: Mapped[list['Movements']] = relationship(back_populates='to_warehouse') 
    outgoing_shipments: Mapped[list['Movements']] = relationship(back_populates='from_warehouse')
...
class Movements(Base):
    ...
    product_id: Mapped[int] = mapped_column(ForeignKey('products.id'))
    responsibl: Mapped[int] = mapped_column(ForeignKey('employee.id'))
